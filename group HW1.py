...
#Imports and concatenates all textfiles into single dataframe
...
#drop all records w/hour numbers 49 and 50 (DST days)
...
#Leaving NaNs from Excel sheet in for now